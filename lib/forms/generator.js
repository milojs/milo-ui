...
var partials = {
    label: fs.readFileSync(__dirname + '/items/partials/label.dot', 'utf-8'),
    formGroup: fs.readFileSync(__dirname + '/items/partials/form_group.dot', 'utf-8'),
    tooltip: fs.readFileSync(__dirname + '/items/partials/tooltip.dot', 'utf-8')
};
