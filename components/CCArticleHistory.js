...
var USING_ELASTICSEARCH_SAVE_HISTORY = (window.CC.config.urlToggles && window.CC.config.urlToggles.elasticsearchHistory) || window.CC && window.CC.config && (window.CC.config.environment == 'development');
